    ...
    <div className="dispos-groupes-container">
      ...
      <div className="activity-container">
        <div className="activity-content">
          ...
          {selectedType === 'list' && (
            <SlotList 
              key={`group-slots-${selectedDate || 'all'}-${lieuFilter}-${organizerFilter}-${filterVersion}`}
              activity="Tous"
              currentUser={currentUser}
          ...
          {selectedType === 'calendar' && (
            <Calendar 
              key={`group-slots-calendar-${selectedDate || 'all'}-${lieuFilter}-${organizerFilter}-${filterVersion}`}
              activity="Tous"
              currentUser={currentUser}
